          ...
          >
            {personalInfo.github && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                style={{ color: col, fontWeight: 700, textDecoration: "none" }}
              >
                GitHub ↗
              </a>
            )}
          ...
          {resume.education.map((e, i) => (
            ...
            >
              <div>
                ...
                <div style={{ fontSize: fs * 0.78, color: "#64748b" }}>
                  {e.school}
                </div>
              </div>
              {e.year && (
                <div style={{ fontSize: fs * 0.74, color: "#94a3b8" }}>
                  {e.year}
                </div>
              )}
            </div>
          ...
          {resume.experience.map((e, i) => (
            <div key={i} style={{ marginBottom: gap }}>
              ...
              >
                ...
                <span style={{ fontSize: fs * 0.72, color: "#94a3b8" }}>
                  {e.duration}
                </span>
              </div>
              {e.company && (
